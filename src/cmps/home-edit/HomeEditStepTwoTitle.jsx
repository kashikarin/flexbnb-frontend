export function HomeEditStepTwoTitle() {
  return (
    <section
      className="home-edit-step-2-title-container"
      style={{ marginBlockStart: '5em', paddingInline: '0' }}
    >
      <article className="home-edit-step-2-title-text-container">
        <div className="home-edit-step-2-title-title">Step 2</div>
      ...
      <article className="home-edit-step-2-title-video-container">
        <video
          ...
          playsInline
          preload="auto"
          className="home-edit-step-2-video"
        />
      </article>
    </section>
  )
